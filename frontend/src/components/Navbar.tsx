...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-base-300 bg-base-100">
          ...
          <div className="flex items-center gap-2">
            ...
            {authUser && (
              <>
                ...
                <button type="button" className="btn btn-ghost btn-sm gap-2" onClick={() => void logout()}>
